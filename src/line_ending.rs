...
/// An iterator over the lines of a string, as tuples of a string
/// slice and a [`LineEnding`] value. It only emits non-empty lines
/// (i.e. having some content before the terminating `\r\n` or `\n`).
///
